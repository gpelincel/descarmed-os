<div id="modal-cad-classificacao" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700 p-4">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="modal-cad-classificacao">
            ...
            <form action="/configuracao/classificacao" method="POST">
                ...
                @method('POST')
                <div class="m-4">
                    <label for="descricao" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nova
                        Classificação</label>
