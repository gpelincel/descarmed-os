<div class="mx-auto max-w-screen-xl px-4 lg:px-12">
    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden w-full">
        ...
        {{-- Topbar --}}
        <x-table-top :label="'usuario'"></x-table-top>

        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">

                <x-table-header :headers="['Nome', 'Usuário']"></x-table-header>
                    ...
                    @foreach ($usuarios as $usuario)
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                <button
                                    data-dropdown-toggle="{{ $usuario->id }}-usuario-dropdown"
                                    ...
                                    <ul class="py-1 text-sm">
                                        <li>
                                            <button onclick="openModalEquipamentoUpdate({{ $usuario->id }})"
                                                ...
                                                data-modal-toggle="modal-update-usuario"
                                        ...
                                        <li>
                                            <button type="button"
                                                onclick="openModalRead(event, {{ $usuario->id }})"
                                                class="flex w-full py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                        ...
                                        <li>
                                            <button type="button" onclick="openModalDelete({{ $usuario->id }})"
...
<script>
    function openModalDelete(id) {
        ...
        formDelete.setAttribute('action', '/usuario/delete/' + id);
    }
</script>
