    ...
    <section class="flex flex-col gap-4 mx-auto max-w-screen-xl px-4 lg:px-12 text-gray-900 dark:text-white mb-8">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2 h-10">
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><i class="fi fi-rr-edit"></i> Editar</button>
                <button type="button" data-modal-target="deleteModal" data-modal-toggle="deleteModal" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"><i class="fi fi-rr-trash"></i> Deletar</button>
            </div>
        </div>
        <hr class="border-gray-600 dark:border-gray-500">
        <ul class="flex gap-8">
            <li>
